  ...
  return recipes
    .map(
      ({ title, description, preview }) =>
        `<div class="kz-card-favorite" style="background: linear-gradient(1deg, rgba(5, 5, 5, 0.6) 0%, rgba(5, 5, 5, 0) 100%), url(${preview}), lightgray -25px -10px / 116.716% 114.018% no-repeat;">
    ...
    <div class="kz-rating-stars"><p class="kz-rating-number">4.5</p><svg class="kz-star-icon unfulfill" width="18" height="18">
